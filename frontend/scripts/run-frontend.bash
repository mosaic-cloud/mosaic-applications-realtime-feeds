...
_jar="${_java_jars:-${_workbench}/../../mosaic-components-jetty/target}/components-jetty-0.4.0-jar-with-dependencies.jar"
_war="${_java_jars:-${_workbench}/target}/examples-realtime-feeds-frontend-0.4.0.war"
